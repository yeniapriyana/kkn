...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="home.php"><img src="tampilan/home.jpg" width="30"><span>Beranda</span> </a> </li>
        <li><a href="kelompok.php"><img src="tampilan/kelompok.jpg" width="30"><span>Info Kelompok </span> </a></li>
        <li><a href="desapembimbing.php"><img src="tampilan/map.jpg" width="30"><span>Info Desa dan Pembimbing</span> </a></li>
        <li class="subnavbar-open-right"><a href="pengumuman.php"><img src="tampilan/pengumuman.jpg" width="30"><span>Pengumuman dari DPL</span> </a> </li>
  ...
  <div class="main-inner">
    <div class="container">
      <div class="row">
        ...
        <h3>Welcome to Sistem Data dan Informasi KKN Universitas Lampung!  </h3>
      </div> 
            <!-- /widget-header -->
            <div class="widget-content">
              <h3>Berikut adalah penjelasan mengenai aturan Sistem Informasi KKN Universitas Lampung</h3>
                <p></p><h4>1. Pelaksanaan KKN Universitas Lampung saat ini merupakan pelaksanaan Periode juli Tahun 2017.</h4><p></p>
                <p></p><h4>2. Pendaftaran KN Universitas Lampung dimulai sejak tanggal 28 Maret 2017 s/d 28 April 2017.</h4><p></p>
                <p></p><h4>3. Pengumuman informasi pengelompokan akan tersedia mulai tanggal 24 Juni 2017.</h4><p></p>
                <p></p><h4>4. Info lebih lanjut hubungi Badan Pelaksana Kuliah Kerja Nyata (BP-KKN) Universitas Lampung.</h4><p></p>
            </div>
          </div>
        </div>
        <!-- /span6 --> 
