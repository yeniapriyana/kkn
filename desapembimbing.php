...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li><a href="home.php"><img src="tampilan/home.jpg" width="30"><span>Beranda</span> </a> </li>
        <li><a href="kelompok.php"><img src="tampilan/kelompok.jpg" width="30"><span>Info Pengelompokan</span> </a></li>
        <li class="active"><a href="desapembimbing.php"><img src="tampilan/map.jpg" width="30"><span>Info Desa dan Pembimbing</span> </a></li>
        <li class="subnavbar-open-right"><a href="pengumuman-admin.php"><img src="tampilan/pengumuman.jpg" width="30"><span>Pengumuman dari DPL</span> </a> </li>
  ...
  <div class="main-inner">
    <div class="container">
      <div class="row">
        ...
        <h3>Tidak Ada Informasi Desa dan Pembimbing Terkait KKN Periode Juli 2017 saat ini.</h3><br>
