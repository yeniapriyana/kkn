  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="kelompok-admin.php"><img src="tampilan/kelompok.jpg" width="30"><span>Info Pengelompokan</span> </a></li>
        <li><a href="desapembimbing-admin.php"><img src="tampilan/map.jpg" width="30"><span>Info Desa dan Pembimbing</span> </a></li>
        <li class="active subnavbar-open-right"><a href="pengumuman-admin.php"><img src="tampilan/pengumuman.jpg" width="30"><span>Pengumuman dari DPL</span> </a> </li>
        <li class=><a href="daftar-user.php"><img src="tampilan/kelompok.jpg" width="30"><span>Daftar User</span> </a> </li>
